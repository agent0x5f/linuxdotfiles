...
-- CPU rings
{
    ...
    hand_fg_colour=0x29BEF0,       hand_fg_alpha=1.0,
    txt_radius=33,
    txt_weight=1.0,                  txt_size=8.0,
    txt_fg_colour=0x29BEF0,        txt_fg_alpha=1.0,
...
-- Storage rings
{
    name='fs_used_perc',           arg='/home',                 max_value=40,
    x=70,                          y=455,
    graph_radius=60,
    graph_thickness=8,
    graph_start_angle=180,
    graph_unit_angle=7.1,          graph_unit_thickness=2.7,
    graph_bg_colour=0xffffff,      graph_bg_alpha=0.1,
    graph_fg_colour=0xFFFFFF,      graph_fg_alpha=0.3,
    hand_fg_colour=0x29BEF0,       hand_fg_alpha=1.0,
    txt_radius=70,
...
{
    name='fs_used_perc',           arg='/',			max_value=240,
    x=70,                          y=455,
    graph_radius=48,
    graph_thickness=7.9,
    graph_start_angle=180,
